...
void rotateQueue(int *q, int front, int rear, int k) { // FIRST ELEMENT GOES TO LAST SHIFT LEFT
...
void rotateRight(int *q, int front, int rear, int k) { // LAST ELEMENT GOES TO FIRST SHIFT RIGHT
    int n = rear - front + 1;
    if (n==0) return; // empty queue
